...
class UserAgent extends Component {
    ...
    public function getIsMobileHost() {
        return (bool) strpos(Yii::$app->getRequest()->hostInfo,
    ...
    private function parseData($userAgent) {
        ...
        } else if(preg_match($tplDesktop, $userAgent, $matches)) {
        ...
        } else if (preg_match($tplBot, $userAgent, $matches) > 0) {
